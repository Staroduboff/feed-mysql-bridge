...
window.SB_I18N = (function () {
  const D = {
    ru: {
      ...
      no_markets_open: 'Сейчас ставки по этому матчу приостановлены',
      tab_all: 'Все', tab_total: 'Тотал', tab_handicap: 'Фора', tab_popular: 'Популярные',
      mf_half1: '1-й тайм', mf_half2: '2-й тайм', mf_corners: 'Угловые', mf_cards: 'Жёлтые карточки',
      mf_shots_target: 'Удары в створ', mf_fouls: 'Фолы', mf_offsides: 'Офсайды', mf_shots: 'Удары', mf_saves: 'Сейвы',
      ...
      lang: 'Язык', theme: 'Оформление',
      theme_dark: 'Тёмная', theme_light: 'Светлая', theme_classic: 'Классика', theme_pulse: 'Пульс', theme_market: 'Рынок',
      alert_offline: 'Нет связи с сервером котировок — цены не обновляются. Переподключаемся…',
      alert_stale: 'Линия обновлялась {min} мин назад — данные могут отставать от фида',
      alert_sublimit: 'Сервер котировок ограничил число подписок: {n} матчей обновляются только раз в минуту',
      alert_gate: 'Приём ставок приостановлен: фид поставщика недоступен. Линию видно, ставки временно не принимаются',
      empty_live_title: 'Сейчас нет матчей в лайве',
      empty_live_text: 'Лайв идёт не круглосуточно — линия вернётся к началу ближайших матчей.',
      empty_live_soon: 'Лайв идёт не круглосуточно. Ближайший матч — {when}.',
      empty_live_next: 'Ближайшие матчи',
      empty_live_btn: 'Смотреть линию',
    ...
    en: {
      ...
      no_markets_open: 'Betting on this match is paused right now',
      tab_all: 'All', tab_total: 'Totals', tab_handicap: 'Handicaps', tab_popular: 'Popular',
      mf_half1: '1st Half', mf_half2: '2nd Half', mf_corners: 'Corners', mf_cards: 'Yellow Cards',
      mf_shots_target: 'Shots on Target', mf_fouls: 'Fouls', mf_offsides: 'Offsides', mf_shots: 'Shots', mf_saves: 'Saves',
      ...
      lang: 'Language', theme: 'Appearance',
      theme_dark: 'Dark', theme_light: 'Light', theme_classic: 'Classic', theme_pulse: 'Pulse', theme_market: 'Market',
      alert_offline: 'No connection to the odds server — prices are not updating. Reconnecting…',
      alert_stale: 'The line was updated {min} min ago — data may lag behind the feed',
      alert_sublimit: 'The odds server limited the number of subscriptions: {n} matches update only once a minute',
      alert_gate: 'Bet placement is paused: the provider feed is unavailable. The line is visible, bets are not accepted for now',
      empty_live_title: 'No live matches right now',
      empty_live_text: 'In-play is not round the clock — the line returns when the next matches start.',
      empty_live_soon: 'In-play is not round the clock. Next match — {when}.',
      empty_live_next: 'Upcoming matches',
      empty_live_btn: 'Open the line',
    ...
    es: {
      ...
      no_markets_open: 'Las apuestas de este partido están pausadas',
      tab_all: 'Todos', tab_total: 'Totales', tab_handicap: 'Hándicaps', tab_popular: 'Populares',
      mf_half1: '1ª Parte', mf_half2: '2ª Parte', mf_corners: 'Córners', mf_cards: 'Tarjetas amarillas',
      mf_shots_target: 'Tiros a puerta', mf_fouls: 'Faltas', mf_offsides: 'Fueras de juego', mf_shots: 'Tiros', mf_saves: 'Atajadas',
      ...
      lang: 'Idioma', theme: 'Apariencia',
      theme_dark: 'Oscuro', theme_light: 'Claro', theme_classic: 'Clásico', theme_pulse: 'Pulso', theme_market: 'Mercado',
      alert_offline: 'Sin conexión con el servidor de cuotas: los precios no se actualizan. Reconectando…',
      alert_stale: 'La línea se actualizó hace {min} min: los datos pueden ir por detrás del feed',
      alert_sublimit: 'El servidor de cuotas limitó el número de suscripciones: {n} partidos se actualizan solo una vez por minuto',
      alert_gate: 'La aceptación de apuestas está en pausa: el feed del proveedor no está disponible. La línea se ve, las apuestas no se aceptan por ahora',
      empty_live_title: 'Ahora no hay partidos en vivo',
      empty_live_text: 'El en vivo no es las 24 horas: la línea vuelve cuando empiecen los próximos partidos.',
      empty_live_soon: 'El en vivo no es las 24 horas. Próximo partido: {when}.',
      empty_live_next: 'Próximos partidos',
      empty_live_btn: 'Ver la línea',
      show_more: 'Mostrar {n} más',
    },
    pt: {
      ...
      no_markets_open: 'As apostas neste jogo estão pausadas',
      tab_all: 'Todos', tab_total: 'Totais', tab_handicap: 'Handicaps', tab_popular: 'Populares',
      mf_half1: '1º Tempo', mf_half2: '2º Tempo', mf_corners: 'Escanteios', mf_cards: 'Cartões amarelos',
      mf_shots_target: 'Chutes no alvo', mf_fouls: 'Faltas', mf_offsides: 'Impedimentos', mf_shots: 'Chutes', mf_saves: 'Defesas',
      ...
      lang: 'Idioma', theme: 'Aparência',
      theme_dark: 'Escuro', theme_light: 'Claro', theme_classic: 'Clássico', theme_pulse: 'Pulso', theme_market: 'Mercado',
      alert_offline: 'Sem conexão com o servidor de odds — os preços não estão a atualizar. A reconectar…',
      alert_stale: 'A linha foi atualizada há {min} min — os dados podem estar atrasados em relação ao feed',
      alert_sublimit: 'O servidor de odds limitou o número de subscrições: {n} jogos atualizam apenas uma vez por minuto',
      alert_gate: 'A aceitação de apostas está pausada: o feed do fornecedor está indisponível. A linha está visível, as apostas não são aceites por agora',
      empty_live_title: 'Não há jogos ao vivo neste momento',
      empty_live_text: 'O ao vivo não é 24 horas — a linha volta quando começarem os próximos jogos.',
      empty_live_soon: 'O ao vivo não é 24 horas. Próximo jogo — {when}.',
      empty_live_next: 'Próximos jogos',
      empty_live_btn: 'Ver a linha',
