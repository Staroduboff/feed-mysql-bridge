...
--------------
    ...
    python bridge.py --sweep      # сборщик (TTL фида, аномалии, ретенция) и выход — по крону
...
from feedbridge.sweep import Sweeper
...
def main() -> None:
    ...
    parser.add_argument("--sweep", action="store_true",
                        help="Сборщик: пометить истёкшие по TTL фида объекты, проверить аномалии, "
                             "удалить по ретенции; затем выход (см. feedbridge/sweep.py)")
